...
namespace MaerskLine.Controllers
{
    ...
    public class ShipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipDate,ShipName,ShipAddress")] Ship ship)
        {
            /*if (ModelState.IsValid)
            {
                db.Ships.Add(ship);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShipID,ShipDate,ShipName,ShipAddress")] Ship ship)
        {
            if (ModelState.IsValid)
            {
